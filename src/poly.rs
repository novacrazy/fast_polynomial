...
Unless you are micro-optimizing, it's recommended to use `poly` or `poly_f`
*/
...
#[inline(always)]
pub fn poly_1<F: Float>(x: F, c0: F, c1: F) -> F {
    fma(x, c1, c0)
}

#[inline(always)]
pub fn poly_2<F: Float>(x: F, x2: F, c0: F, c1: F, c2: F) -> F {
    fma(x2, c2, fma(x, c1, c0))
}

#[inline(always)]
pub fn poly_3<F: Float>(x: F, x2: F, c0: F, c1: F, c2: F, c3: F) -> F {
    // x^2 * (x * c3 + c2) + (x*c1 + c0)
    fma(x2, fma(x, c3, c2), fma(x, c1, c0))
}

#[inline(always)]
pub fn poly_4<F: Float>(x: F, x2: F, x4: F, c0: F, c1: F, c2: F, c3: F, c4: F) -> F {
    // x^4 * c4 + (x^2 * (x * c3 + c2) + (x*c1 + c0))
    fma(x4, c4, fma(x2, fma(x, c3, c2), fma(x, c1, c0)))
}

#[inline(always)]
pub fn poly_5<F: Float>(x: F, x2: F, x4: F, c0: F, c1: F, c2: F, c3: F, c4: F, c5: F) -> F {
...
#[rustfmt::skip]
#[inline(always)]
pub fn poly_6<F: Float>(x: F, x2: F, x4: F, c0: F, c1: F, c2: F, c3: F, c4: F, c5: F, c6: F) -> F {
...
#[rustfmt::skip]
#[inline(always)]
pub fn poly_7<F: Float>(x: F, x2: F, x4: F, c0: F, c1: F, c2: F, c3: F, c4: F, c5: F, c6: F, c7: F) -> F {
    fma(x4,
